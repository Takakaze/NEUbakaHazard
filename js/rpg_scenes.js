...
//作者：鳗驼螺
//链接：https://www.jianshu.com/p/527a82a2fd6a
//來源：简书
...
Scene_Title.prototype.createForeground = function () {
    ...
    {
        var gameLogo = ImageManager.loadBitmap("img/title/", "GameLogo");
...
Scene_GameEnd.prototype.createCommandWindow = function() {
    ...
    this._commandWindow.setHandler('exit', this.commandEndgame.bind(this));
    this._commandWindow.setHandler('cancel',   this.popScene.bind(this));
    this.addWindow(this._commandWindow);
};
...
Scene_GameEnd.prototype.commandEndgame = function () {
    this.fadeOutAll();
    window.close();
};
